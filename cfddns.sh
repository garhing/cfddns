...
# Place at:
# curl https://raw.githubusercontent.com/garhing/cfddns/master/cfddns.sh > /usr/local/bin/cfddns.sh && chmod +x /usr/local/bin/cfddns.sh
# run `crontab -e` and add next line:
# */1 * * * * /usr/local/bin/cfddns.sh >/dev/null 2>&1
# or you need log:
# */1 * * * * /usr/local/bin/cfddns.sh >> /var/log/cfddns.log 2>&1


# Usage:
# cfddns.sh -k cloudflare-api-key \
#            -u user@example.com \
