...
echo 正在配置cfddns
sed -i -e "s/CFKEY=/$cfkey/g" cfddns.sh
sed -i -e "s/CFUSER=/$cfuser/g" cfddns.sh
sed -i -e "s/CFZONE_NAME=/$cfname/g" cfddns.sh
sed -i -e "s/CFRECORD_NAME=/$record/g" cfddns.sh
echo 'ddns配置完成'
